...
-- import hotel
CREATE TABLE temp_hotel(id INTEGER, title TEXT NOT NULL, zip_code VARCHAR(15) NOT NULL,
...
FROM '/tmp/csv/hotel0.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/tmp/csv/hotel1.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/tmp/csv/hotel2.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/tmp/csv/hotel3.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/tmp/csv/hotel4.csv' DELIMITER ',' CSV HEADER;
...
-- import guest
CREATE TABLE temp_guest (id INTEGER, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, phone VARCHAR(20) NOT NULL);
COPY temp_guest(id, first_name,last_name,email,phone)
FROM '/tmp/csv/guest.csv' DELIMITER ',' CSV HEADER;
...
-- import room
CREATE TABLE temp_room (id INTEGER, beds SMALLINT NOT NULL, hotel_id INTEGER REFERENCES hotel(id));
COPY temp_room(id,beds,hotel_id)
FROM '/tmp/csv/room.csv' DELIMITER ',' CSV HEADER;
...
-- import booking
CREATE TABLE temp_booking (id INTEGER,guest_id INTEGER REFERENCES guest(id),room_id INTEGER REFERENCES room(id),check_in DATE NOT NULL,check_out DATE NOT NULL);
COPY temp_booking(id,guest_id,room_id,check_in,check_out)
FROM '/tmp/csv/booking.csv' DELIMITER ',' CSV HEADER;
...
-- import room_rate
CREATE TABLE temp_room_rate (id INTEGER,service_id SMALLINT NOT NULL,service_title VARCHAR(30) NOT NULL,price INTEGER NOT NULL,day_Date DATE NOT NULL,room_id INTEGER REFERENCES room(id));

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate0.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate1.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate2.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate3.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate4.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate5.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate6.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate7.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate8.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/tmp/csv/roomRate9.csv' DELIMITER ',' CSV HEADER;

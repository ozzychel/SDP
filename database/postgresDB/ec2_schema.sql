...
FROM '/home/ec2-user/data/postgresData/hotel0.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/home/ec2-user/data/postgresData/hotel1.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/home/ec2-user/data/postgresData/hotel2.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/home/ec2-user/data/postgresData/hotel3.csv' DELIMITER ',' CSV HEADER;

COPY temp_hotel(id,title,zip_code,address,url,rating,reviews_total,rooms_total)
FROM '/home/ec2-user/data/postgresData/hotel4.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/ec2-user/data/postgresData/guest.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/ec2-user/data/postgresData/room.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/ec2-user/data/postgresData/booking.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/ec2-user/data/postgresData/roomRate0.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate1.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate2.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate3.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate4.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate5.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate6.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate7.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate8.csv' DELIMITER ',' CSV HEADER;

COPY temp_room_rate(id,service_id,service_title,price,day_Date,room_id)
FROM '/home/ec2-user/data/postgresData/roomRate9.csv' DELIMITER ',' CSV HEADER;
